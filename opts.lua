...
function opts.parse(arg)
  ...
  cmd:option('--crop',                    'r', 'Spatial cropping method. random is uniform. corner is selection from 4 corners and 1 cetner. (r | c)')
  ...
  cmd:option('--resnet_depth',            18, 'Depth of resnet')
  cmd:option('--shortcut_type',           'A', 'Shortcut type of resnet')
